...
void main() {
  ...
  group('Connectivity mapping logic', () {
    test('mapping logic follows priority: wifi > ethernet > mobile > none', () {
      ...
      expect(
        mapResult([ConnectivityResult.wifi]),
        ParseConnectivityResult.wifi,
      );
      expect(
        mapResult([ConnectivityResult.ethernet]),
        ParseConnectivityResult.ethernet,
      );
      expect(
        mapResult([ConnectivityResult.mobile]),
        ParseConnectivityResult.mobile,
      );
      expect(
        mapResult([ConnectivityResult.none]),
        ParseConnectivityResult.none,
      );

      // Test priority when multiple connections exist
      expect(
        mapResult([ConnectivityResult.wifi, ConnectivityResult.ethernet]),
        ParseConnectivityResult.wifi,
      );
      expect(
        mapResult([ConnectivityResult.wifi, ConnectivityResult.mobile]),
        ParseConnectivityResult.wifi,
      );
      expect(
      ...
      expect(
        mapResult([ConnectivityResult.bluetooth]),
        ParseConnectivityResult.none,
      );
      expect(mapResult([ConnectivityResult.vpn]), ParseConnectivityResult.none);
      expect(
        mapResult([ConnectivityResult.other]),
        ParseConnectivityResult.none,
      );
