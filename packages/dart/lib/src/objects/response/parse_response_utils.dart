...
@protected
ParseResponse handleResponse<T>(dynamic object, ParseNetworkResponse<String> response,
...
bool isUnsuccessfulResponse(ParseNetworkResponse<String> apiResponse) =>
    apiResponse.statusCode != 200 && apiResponse.statusCode != 201;

bool isSuccessButNoResults(ParseNetworkResponse<String> apiResponse) {
