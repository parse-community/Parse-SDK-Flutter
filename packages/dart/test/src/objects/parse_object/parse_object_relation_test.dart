...
void main() {
  group('Relation', () {
    ...
    test('getTargetClass() should rerun the target class for the relation if '
    ...
    test('getTargetClass() should return the target class for a relation when'
    ...
    test('getQuery() should return QueryBuilder utilizing the '
    ...
    test(
      ...
      () {
        ...
        final relationValueForApiReq = dietPlansObject
            .getRelation('someRelationKey')
            .toJson();
        expect(relationValueForApiReq.isEmpty, isTrue);
      },
    );

    test('The Relation value and the value for api request should be identical '
      ...
      final relationInternalStateBeforeErrorSave = dietPlansObject
          .getRelation('someRelationKey')
          .toJson(full: true);
      ...
      final relationInternalStateAfterErrorSave = dietPlansObject
          .getRelation('someRelationKey')
          .toJson(full: true);
    ...
    test('ParseRelation value for api request should be identical '
        'before and after the save() failed to save the object', () async {
      // arrange
      ...
      final relationValueForApiReqBeforeErrorSave = dietPlansObject
          .getRelation('someRelationKey')
          .toJson();
      ...
      // assert
      final relationValueForApiReqAfterErrorSave = dietPlansObject
          .getRelation('someRelationKey')
          .toJson();
    ...
    test('The Relation internal state should be identical before and after '
      ...
      // assert
      final toJsonAfterPin = objectFromPin
          .getRelation('someRelationKey')
          .toJson(full: true);
    ...
    test('should throw an exception if the user adds/removes a parse object'
    ...
    test('If the value for API request is empty in ParseRelation then the'
    ...
    test('Should throw exception when getRelation() called on key'
