...
void main() {
  ...
  group('unset()', () {
    ...
    test('unset() should unset a value from ParseObject locally', () async {
      ...
      // act
      final ParseResponse parseResponse = await dietPlansObject.unset(
        keyFat,
        offlineOnly: true,
      );
    ...
    test(
      'unset() should unset a value from ParseObject locally on online',
      () async {
        // arrange
        ...
        const resultFromServer = {keyVarUpdatedAt: "2023-03-04T03:34:35.076Z"};
    ...
    test(
      ...
      () async {
        ...
        // act
        final parseResponse = await dietPlansObject.unset(
          keyFat,
          offlineOnly: false,
        );
    ...
    test(
      ...
      () async {
        ...
        when(
          client.put(any, options: anyNamed("options"), data: anyNamed("data")),
        ).thenAnswer(
          (_) async => ParseNetworkResponse(statusCode: -1, data: errorData),
        );
