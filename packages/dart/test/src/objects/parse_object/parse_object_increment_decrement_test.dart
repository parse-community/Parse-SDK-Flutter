...
void main() {
  ...
  group('Increment/Decrement', () {
    ...
    test('Incrementing values using setIncrement() and then calling get(key) '
    ...
    test('Incrementing not existing values should be handled by assuming'
    ...
    test('setIncrement() operation should not be mergeable with any other'
    ...
    test('Decrementing values using setDecrement() and then calling get(key) '
    ...
    test('Decrementing not existing values should be handled by assuming'
        'that the default value is 0 and operate on it', () {
      // act
      dietPlansObject.setDecrement(keyFat, 1);
      dietPlansObject.setDecrement(keyFat, 2.5);
    ...
    test('mixing and matching Decrements and Increments should not cause '
        'any issue', () {
      // act
      dietPlansObject.setDecrement(keyFat, 2.5);
    ...
    test('setDecrement() operation should not be mergeable with any other'
    ...
    test('When calling clearUnsavedChanges() the number should be reverted back'
    ...
    test('The number internal state should be identical '
    ...
    test('If an Increment/Decrement operation is performed during the save() '
